...
<head>
    ...
    asset('image/keranjang-removebg-preview.png') }}">
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <a class="navbar-brand" href="index.html">
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{{ asset('image/keranjang-removebg-preview.png') }}"
                ...
                <span class="logo-text">
                    <!-- dark Logo text -->
                    <img src="{{ asset('image/logotext-removebg-preview.png') }}" alt="homepage"
                    class="light-logo" />
                    </span>
                    <!-- Logo icon -->
                    <!-- <b class="logo-icon"> -->
...
-->
                    ...
                    waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" ariaexpanded="false">
                            ...
                            @else
                            <img src="{{ asset('storage/img-user/3.jpg') }}"
...
href="http://www.shopee.co.id/">Belanja..? DISINI Aja !!!</a>
                        </footer>
                        <!-- ============================================================== -->
                        <!-- End footer -->
                        <!-- ============================================================== -->
